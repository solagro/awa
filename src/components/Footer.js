...
const Footer = () => {
  ...
  return (
    <Grid
      ...
      spacing={3}
    >
      <Grid item xs={12} md={12} spacing={10}>
      ...
      <Grid
        container
        wrap="nowrap"
        className={classes.footer__partnership_grid}
        spacing={3}
        justify="flex-start"
        alignItems="baseline"
      >
      ...
      <Grid item xs={12} md={12} lg={12} className={classes.footer__logo}>
        <Typography variant="body1" paragraph>
